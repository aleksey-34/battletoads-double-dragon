...
function useLandingTexts(lang: UILanguage) {
  const t: Record<UILanguage, Record<string, any>> = {
    ru: {
      ...
      circuits: [
        { title: 'Runtime', desc: 'Изолированный торговый контур. Перезапуск API и обновление стратегий не влияют на открытые позиции.' },
        { title: 'Research', desc: 'Backtesting, sweep, robustness-фильтрация. Synthetic reconciliation по обеим ногам сделки.' },
    ...
    en: {
      ...
      circuits: [
        { title: 'Runtime', desc: 'Isolated trading circuit. API restarts and strategy updates never interrupt open positions.' },
    ...
    tr: {
      ...
      circuits: [
        { title: 'Runtime', desc: 'İzole ticaret devresi. API yeniden başlatmaları ve strateji güncellemeleri açık pozisyonları etkilemez.' },
